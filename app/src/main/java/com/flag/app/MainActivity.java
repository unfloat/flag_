...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        userProfilePicture = (CircularImageView) headerLayout.findViewById(R.id.profilePicture);
        userProfilePicture.setOnClickListener(view -> navController.navigate(R.id.nav_profile));
